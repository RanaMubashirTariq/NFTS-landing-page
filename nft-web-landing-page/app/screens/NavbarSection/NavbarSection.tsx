      ...
      <div className="flex items-center gap-[20px] h-full max-[1000px]:h-[35px] max-[767px]:gap-[10px] max-[767px]:w-[130px]">
        ...
        <div className="relative flex items-center ">
          ...
          <input
            type="text"
            placeholder="Search..."
            className={`-ml-[40px] max-[400px]:-ml-[30px]  rounded-[45px] transition-all duration-300 pr-3 pl-[50px] py-1 h-[41.25px]  bg-white/20 max-[400px]:bg-[#040914]  text-white text-sm placeholder:text-white 
              ${showSearch ? "w-[180px] max-[400px]:w-[190px] opacity-100" : "w-0 opacity-0"}
            `}
          />
        </div>
      </div>
