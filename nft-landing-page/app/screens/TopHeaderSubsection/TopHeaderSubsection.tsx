...
const statisticsData = [
  { value: "290K+", label: "Artwork" },
  { value: "110K+", label: "Artwork" },
  { value: "99K+", label: "Creatores" },
];
          ...
          />
            ...
            {statisticsData.map((stat, index) => (
              <div key={index} className="text-center min-w-[80px]">
                <div className="[font-family:'Exo2'] font-bold text-white text-2xl sm:text-3xl max-[470px]:text-[22px]">{stat.value}</div>
                <div className="[font-family:'Exo2'] font-medium text-white text-sm max-[470px]:text-[13px]">{stat.label}</div>
              </div>
            ))}
          </div>
                  </div>
