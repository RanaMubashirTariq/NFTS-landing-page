...
export default function SubscribeSubsection  () {
  return (
    <section className="w-full h-[525px] max-[1000px]:h-[850px] max-[500px]:h-[750px] relative">
      <div className="relative w-full h-[525px] max-[1000px]:h-[850px] max-[500px]:h-[750px] bg-[#ffffff0a]">
